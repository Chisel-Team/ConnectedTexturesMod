...
@Mod(name = MOD_NAME, modid = MOD_ID, version = VERSION, dependencies = "required-after:forge@[13.20.0.2228, 14.21.0.2363);@DEPENDENCIES@", acceptedMinecraftVersions = "[1.11.2, 1.12.1)", clientSideOnly = true)
public class CTM {
